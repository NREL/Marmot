...
class mplot(object):
    ...
    def hydro_net_load(self):
       ...
       # try:   #The rest of the function won't work if this particular zone can't be found in the solution file (e.g. if it doesn't include Mexico)
        ...
        try:
            ...
            print("No hydro in "+self.zone_input+".")
        ...
        fig2.savefig(os.path.join(hydro_figures, self.zone_input + "_" + "Hydro_Versus_Net_Load" + "_" + self.Multi_Scenario[0]), dpi=600, bbox_inches='tight')
    ...
    def hydro_continent_net_load(self):
        ...
        fig2.savefig(os.path.join(hydro_figures, self.zone_input + "_" + "Hydro_Versus_Continent_Net_Load" + "_" + self.Multi_Scenario[0]), dpi=600, bbox_inches='tight')
