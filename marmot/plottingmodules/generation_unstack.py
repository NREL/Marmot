        ...
        **_,
        ...
        for zone_input in self.Zones:
            ...
            for i, scenario in enumerate(all_scenarios):
                ...
                Stacked_Curt = (
                    self[f"generator_{self.curtailment_prop}"].get(scenario).copy()
                )
                ...
                vre_gen_cat = [
                    name for name in vre_gen_cat if name in Stacked_Gen.columns
                ]
                ...
                scenario_names = pd.Series(
                    [scenario] * len(Stacked_Gen), name="Scenario"
                )
                ...
                if (Unserved_Energy == 0).all() == False:
                    axs[i].plot(
                        Unserved_Energy, color="#DD0200", label="Unserved Energy"
                    )
