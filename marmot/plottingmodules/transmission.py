...
class Transmission(PlotDataStoreAndProcessor):
    ...
    def line_flow_ind_diff(self, figure_name: str = None, prop: str = None, **_):
        """
        #TODO: Finish Docstring
    ...
    def plot_line_interface_limits(
        self,
        limits: pd.DataFrame,
        mplt: PlotLibrary,
        n: int,
