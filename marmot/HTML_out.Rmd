...
for (section_name in names(sections)){
  ...
  print(file.path(parent_dir,'Figures_Output',paste0(agg_level,sections[section_name])))
  print(list.files(file.path(parent_dir,'Figures_Output',paste0(agg_level,sections[section_name]))))
